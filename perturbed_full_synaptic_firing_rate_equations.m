function dx = perturbed_full_synaptic_firing_rate_equations(~, x, parm, A, p, coord)
    ...
    %%%%%%%%%%%%%%%%%% Perturbing exact firing rate model %%%%%%%%%%%%%%%%%
    ...
    dx = [dre; dVe; dSee; dSei;
          dri; dVi; dSie; dSii];
    dx(coord) = dx(coord) + A*p; % Perturbation on the component/s coord
